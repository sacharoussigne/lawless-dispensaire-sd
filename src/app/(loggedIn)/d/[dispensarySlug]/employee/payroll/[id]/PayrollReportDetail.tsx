...
import { deletePayrollReport, updatePayrollReportResultJson } from '@/app/_actions/payrollReports';
import { handleAction } from '@/lib/action';
import { payrollReportResultSchema, type PayrollReportResult } from '@/lib/payroll/schema';
import { effectiveCaisseUnitUsd, recalculatePayrollResult } from '@/lib/payroll/recalculatePayrollResult';
...
export default function PayrollReportDetail({
  ...
  const handleSave = async () => {
    ...
    setSaving(true);
    try {
      const result = await updatePayrollReportResultJson(dispensarySlug!, report.id, draft);
      handleAction(result);
  ...
  const handleDelete = () => {
    modals.openConfirmModal({
      ...
      onConfirm: async () => {
        try {
          const result = await deletePayrollReport(dispensarySlug!, report.id);
          handleAction(result);
    ...
    <Container size="xl" py="xl">
      <Group justify="space-between" mb="xl" align="flex-start" wrap="wrap">
        ...
        <Group gap="sm" justify="flex-end" wrap="wrap">
          ...
          {canDelete && (
            <Button color="red" variant="light" leftSection={<IconTrash size={18} />} onClick={handleDelete}>
              Supprimer
            </Button>
          )}
        </Group>
      ...
      {!report.errorMessage && parsed.success && draft && (
        <>
          ...
          <Paper shadow="sm" p="md" withBorder mb="lg">
            ...
            <Box mb="sm" pl="xs" ml={2} style={{ borderLeft: '2px solid var(--mantine-color-gray-3)' }}>
                      ...
                      <Group align="flex-start" gap="lg" wrap="wrap" mb="md">
                        <div>
                          ...
                          <NumberInput
                            ...
                            onChange={(v) => {
                              if (v === '' || v === undefined) {
                                patchEmployeePayrollSettings(i, { caisse_unit_override_usd: undefined });
                                return;
                              }
                              ...
                              emp.caisse_unit_override_usd != null ? (
                                <Tooltip label="Revenir au défaut du rapport" withArrow>
                                  <ActionIcon
                                    ...
                                    onClick={() => patchEmployeePayrollSettings(i, { caisse_unit_override_usd: undefined })}
                                  >
                      ...
                      <div>
                        ...
                        {canEdit && isEditing ? (
                          <NumberInput
                            ...
                            onChange={(v) => patchEmployeeStats(i, { sherifs: v === '' || v === undefined ? null : Number(v) })}
                          />
                        ) : (
                      ...
                      <div>
                        ...
                        {canEdit && isEditing ? (
                          <NumberInput
                            ...
                            onChange={(v) => patchEmployeeStats(i, { palefreniers: v === '' || v === undefined ? null : Number(v) })}
                          />
                        ) : (
                      ...
                      <div>
                        ...
                        {canEdit && isEditing ? (
                          <NumberInput
                            ...
                            onChange={(v) => patchEmployeeStats(i, { patients_soignes: v === '' || v === undefined ? 0 : Number(v) })}
                          />
                        ) : (
                      ...
                      <div>
                        ...
                        {canEdit && isEditing ? (
                          <NumberInput
                            ...
                            onChange={(v) => patchEmployeeStats(i, { poppy_milk_offertes: v === '' || v === undefined ? 0 : Number(v) })}
                          />
                        ) : (
                      ...
                      <div>
                        ...
                        {canEdit && isEditing ? (
                          <NumberInput
                            ...
                            onChange={(v) => patchEmployeeStats(i, { infusions_ginseng_offertes: v === '' || v === undefined ? 0 : Number(v) })}
                          />
                        ) : (
